...
public class SecretService implements
		AbstractCrudService<SaveSecretRequestDto, SaveEntityResponseDto, SecretDto, SecretListDto>, CountService, BatchDeletionService {
