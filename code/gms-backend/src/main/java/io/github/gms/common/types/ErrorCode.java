...
public enum ErrorCode {
    ...
    GMS_010("GMS-010"), // You must define at least one keystore alias
    ...
    GMS_017("GMS-017"), // You are not allowed to use this API key for this secret
    ...
    GMS_023("GMS-023"), // You are not allowed to get this secret from your IP address
